...
create domain niveau as varchar(10) check (value in ('recreatif','competitif'));
...
create table if not exists organisation_schema.Joueur(
  ...
  tel varchar(20) not null, -- pas sur du type
  idEquipe varchar(20),
  idEmploye varchar(20)
  ...
  create table if not exists organisation_schema.Equipe(
    ...
    datePaiement varchar(20) not null, --type a changer je pense
    derNumCarte varchar(20) not null,
  ...
  create table if not exists organisation_schema.Match(
    ...
    date varchar(20) not null, --pas sure du type aussi
    heure varchar(20) not null,
    lieu varchar(20) not null,
    idSaison varchar(20),
    idArbitre varchar(20),-- je pense que c'est faut et qu'il faudrait une 3e table arbitreMath
    idTournoi varchar(20),
    idEquipe varchar(20), --meme probleme que arbitre on a plus d'une equipe
    primary key idMatch(20), --j 'ai un doute aussi sur la cle primaire
