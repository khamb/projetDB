<?php
  ...
  while ($donnee = pg_fetch_row($query1))
    {
      ...
      echo "<div class='modal fade' id='delJouModal-$donnee[0]' tabindex='-1' role='dialog' aria-labelledby='delJouModal'>
  ...
  echo "<div class='modal fade' id='editJoueurModal-$donnee[0]' tabindex='-1' role='dialog' aria-labelledby='editEmpModal'>
          <div class='modal-dialog' role='document'>
            <div class='modal-content'>
