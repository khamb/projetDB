<?php
  ...
  $query1 = pg_query($serveur, "SELECT prenom, nom,experience FROM arbitre, employe WHERE arbitre.idEmploye = employe.idEmploye");
  ...
  while ($donnee = pg_fetch_row($query1))
    {
      ...
      echo "<ul class='list-group'>
          ...
          <li class='list-group-item'> <strong> Experience: </strong>".$donnee[2]." ans</li>
          <br>
          ";
      echo "</div>";
    }
